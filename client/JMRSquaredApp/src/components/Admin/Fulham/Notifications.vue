                                                                                ...
                                                                                <GridLayout class="page" verticalAlignment="center" rows="*" @loaded="pageLoaded">
                                                                                    <CardView v-show="!isSecondPage" radius="10" shadowOffsetHeight="10" shadowOpacity="0.2" shadowRadius="50" elevation="60">
                                                                                            <ScrollView>
                                                                                                    ...
                                                                                                    <Label row="0" col="1" verticalAlignment="center" @tap="$modal.close" textAlignment="right" alignSelf="right" class="mdi h1" :text="'mdi-close' | fonticon" color="$redColor"></Label>
                                                                                                    
                                                                                                    <label class="h3 m-10 font-weight-bold" row="0" col="0" colSpan="2" verticalAlignment="center" textAlignment="center" text="Sending a new Notification"></label>
                        ...
                        methods: {
                            ...
                            SubmitNotification() {
                                ...
                                for (let i = 0; i < victims.length; i++) {
                                    http.request({
                                        url: this.$store.state.settings.baseLink + "/n/add",
                                        method: "POST",
                                        headers: {
                                        ...
                                        if (statusCode == 200) {
                                            ...
                                            self.$feedback.error({
                                                title: "Notification not sent to " + victims.map(t => t.text)[i],
                                                message: error,
                                                duration: 4000,
                                                onTap: () => {
