      ...
      <StackLayout orientation="vertical">
        <GridLayout alignSelf="center" columns="*" rows="*,*,*" padding="10%">
          <StackLayout alignSelf="center" rowSpan="3" col="1">
            ...
            <Label textAlignment="center" col="1" row="2" height="20" :text="user.username + ' ' + profileID "></Label>
            <Image @tap="pageLoaded" alignSelf="center" borderWidth="5px" borderColor="#9933CC" stretch="aspectFill" col="1" row="3" :src="user.profilePic" width="100" height="100" borderRadius="50%" backgroundColor="#1c6b48" />
          </StackLayout>
        </GridLayout>
