...
export default class API {
    ...
    getAuthToken() {
        return new Promise((resolve, reject) => {
            http.request(this.makePost('/token', {
                "email": "sacsac",
                "password": "cwevwvasc",
    ...
    getAllBusinessesForUser(adminID) {
        return new Promise((resolve, reject) => {
            if (this.getInternetStatus() == connectivity.connectionType.none) {
                ...
                http
                    .getJSON(this.makeGet("/b/all/for/" + adminID)).then(result => {
    ...
    getBusiness(businessID, adminID) {
        return new Promise((resolve, reject) => {
            if (this.getInternetStatus() == connectivity.connectionType.none) {
                ...
                http
                    .getJSON(this.makeGet(`/b/get/${businessID}/for/${adminID}`)).then(result => {
    ...
    getBusinessIncomes(businessID) {
        return new Promise((resolve, reject) => {
            http
                .getJSON(this.makeGet(`/b/get/all/incomes/for/${businessID}`)).then(result => {
                    return resolve(result);
                }).catch(err => {
                    return reject(err);
                });
    ...
    getBusinessExpenses(businessID) {
        return new Promise((resolve, reject) => {
            http
                .getJSON(this.makeGet(`/b/get/all/expenses/for/${businessID}`)).then(result => {
                    return resolve(result);
                }).catch(err => {
                    return reject(err);
                });
    ...
    addBusinessExpense(businessID, value) {
        return new Promise((resolve, reject) => {
            http.request(this.makePost("/b/set/business/expense", {
                businessID,
                value
            })).then((result) => {
                return resolve(result)
    ...
    addBusinessIncome(businessID, value) {
        return new Promise((resolve, reject) => {
            http.request(this.makePost("/b/set/business/income", {
                businessID,
                value
            })).then((result) => {
                return resolve(result)
